...
#Uptaded Lu - removed human-mediated variables
...
#Active 2 (pare15, cryptic15,resid25,transi25) - rerun
...
#Passive (no larval behaviour) - rerun
...
##27/05/2021 - MODELS REVISED (LU F. AND STEPH D.)
#########################
#####BUILDING MODELS#####
#########################----
...
###END----
saveRDS(MOD_S_1_run_PASSIVE, "Models output/MOD_S_1_run_PASSIVE_June.Rds")
saveRDS(MOD_S_2_run_PASSIVE, "Models output/MOD_S_2_run_PASSIVE_June.Rds")
saveRDS(MOD_S_3_run_PASSIVE, "Models output/MOD_S_3_run_PASSIVE_June.Rds")
saveRDS(MOD_S_4_run_PASSIVE, "Models output/MOD_S_4_run_PASSIVE_June.Rds")
saveRDS(MOD_S_1_run_ACTIVE.2, "Models output/MOD_S_1_run_ACTIVE.2_June.Rds")
saveRDS(MOD_S_2_run_ACTIVE.2, "Models output/MOD_S_2_run_ACTIVE.2_June.Rds")
saveRDS(MOD_S_3_run_ACTIVE.2, "Models output/MOD_S_3_run_ACTIVE.2_June.Rds")
saveRDS(MOD_S_4_run_ACTIVE.2, "Models output/MOD_S_4_run_ACTIVE.2_June.Rds")
saveRDS(MOD_BIOM_1_run_PASSIVE, "Models output/MOD_BIOM_1_run_PASSIVE_June.Rds")
saveRDS(MOD_BIOM_2_run_PASSIVE, "Models output/MOD_BIOM_2_run_PASSIVE_June.Rds")
saveRDS(MOD_BIOM_3_run_PASSIVE, "Models output/MOD_BIOM_3_run_PASSIVE_June.Rds")
saveRDS(MOD_BIOM_1_run_ACTIVE.2, "Models output/MOD_BIOM_1_run_ACTIVE.2_June.Rds")
saveRDS(MOD_BIOM_2_run_ACTIVE.2, "Models output/MOD_BIOM_2_run_ACTIVE.2_June.Rds")
saveRDS(MOD_BIOM_3_run_ACTIVE.2, "Models output/MOD_BIOM_3_run_ACTIVE.2_June.Rds")
