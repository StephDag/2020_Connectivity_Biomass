...
saveRDS(MOD_S_1_run_TRANSIENT,"Models/ACTIVE V2/MOD_S_1_run_TRANSIENT_null_V2.Rds")
...
saveRDS(MOD_S_1_run_TRANSIENT,"Models/ACTIVE V2/MOD_S_1_run_TRANSIENT_V2.Rds")
  # model 2
...
MOD_S_2_run_TRANSIENT <-brm(MOD_2_S , data=TRANSIENT.std,cores=4,chains = 4,
                            iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                            prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(MOD_S_2_run_TRANSIENT,"Models/ACTIVE V2/MOD_S_2_run_TRANSIENT_V2.Rds")
...
MOD_S_3_run_TRANSIENT <-brm(MOD_3_S , data=TRANSIENT.std,cores=4,chains = 4,
                            iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                            prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(MOD_S_3_run_TRANSIENT,"Models/ACTIVE V2/MOD_S_3_run_TRANSIENT_V2.Rds")
...
MOD_S_4_run_TRANSIENT <-brm(MOD_4_S , data=TRANSIENT.std,cores=4,chains = 4,
                            iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                            prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(MOD_S_4_run_TRANSIENT,"Models/ACTIVE V2/MOD_S_4_run_TRANSIENT_V2.Rds")
...
model.W.transient.S <- model_weights(MOD_S_1_run_TRANSIENT_null,MOD_S_1_run_TRANSIENT,
              MOD_S_2_run_TRANSIENT,MOD_S_3_run_TRANSIENT,
              MOD_S_4_run_TRANSIENT,MOD_S_env,weights="loo")
names(model.W.transient.S) <- c("S_model_null","S_model_1","S_model_2","S_model_3","S_model_4","S_model_ENV")
...
MOD_BIOM_1_run_TRANSIENT.null <-brm(MOD_B.null , data=TRANSIENT.std,cores=4,chains = 4,
                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30))
saveRDS(MOD_BIOM_1_run_TRANSIENT,"Models/ACTIVE V2/MOD_BIOM_1_run_TRANSIENT_V2.Rds")
...
MOD_BIOM_2_run_TRANSIENT <-brm(MOD_2_B , data=TRANSIENT.std,cores=4,chains = 4,
                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                               prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(MOD_BIOM_2_run_TRANSIENT,"Models/ACTIVE V2/MOD_BIOM_2_run_TRANSIENT_V2.Rds")
...
MOD_BIOM_3_run_TRANSIENT <-brm(MOD_3_B , data=TRANSIENT.std,cores=4,chains = 4,
                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                               prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(MOD_BIOM_3_run_TRANSIENT,"Models/ACTIVE V2/MOD_BIOM_3_run_TRANSIENT_V2.Rds")
...
MOD_BIOM_4_run_TRANSIENT <-brm(MOD_4_B , data=TRANSIENT.std,cores=4,chains = 4,
                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                               prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(MOD_BIOM_4_run_TRANSIENT,"Models/ACTIVE V2/MOD_BIOM_4_run_TRANSIENT_V2.Rds")
...
MOD_BIOM_5_run_TRANSIENT <-brm(MOD_5_B , data=TRANSIENT.std,cores=4,chains = 4,
                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                               prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(MOD_BIOM_5_run_TRANSIENT,"Models/ACTIVE V2/MOD_BIOM_5_run_TRANSIENT_V2.Rds")
...
r2_bayes.transient.B <- rbind(c(r2_bayes(MOD_BIOM_1_run_TRANSIENT.null)[1],
                                ...
                                r2_bayes(MOD_BIOM_4_run_TRANSIENT)[1],
                              ...
                              c(r2_bayes(MOD_BIOM_1_run_TRANSIENT.null)[2],
                                ...
                                r2_bayes(MOD_BIOM_4_run_TRANSIENT)[2],
                                r2_bayes(MOD_B_env)[2]))
colnames(r2_bayes.transient.B) <- c("B_model_null","B_model_1","B_model_2","B_model_3","B_model_4","B_model_ENV")
rownames(r2_bayes.transient.B) <- rep("TRANSIENT",2)
model.W.transient.B <- model_weights(MOD_BIOM_1_run_TRANSIENT.null,MOD_BIOM_1_run_TRANSIENT,
                                     MOD_BIOM_2_run_TRANSIENT,MOD_BIOM_3_run_TRANSIENT,
                                     MOD_BIOM_4_run_TRANSIENT,MOD_B_env,weights="loo")
names(model.W.transient.B) <- c("B_model_null","B_model_1","B_model_2","B_model_3","B_model_4","B_model_ENV")
rownames(model.W.transient.B) <- rep("TRANSIENT",1)

#plot(conditional_effects(MOD_BIOM_2_run_TRANSIENT))

# Model 1 species richness
coef_plot_model1_S_transient <- mcmc_plot(MOD_S_1_run_TRANSIENT, pars = "^b_")
# Model 1 biomass
coef_plot_model1_B_transient <- mcmc_plot(MOD_BIOM_1_run_TRANSIENT, pars = "^b_")
