...
species_mod_inflow.intr.extr <- bf(Richness ~ temp + prod.annual + log_grav_total+Class+Netflow  + log_Inflow+
                                     log_SelfR + log_btwdegree +log_grav_neiBR + log_InflowNei +log_CorridorIn + 
                                     (1+   temp + prod.annual + log_grav_total + log_Inflow+
...
biom_mod_inflow.intr.extr <- bf(log_biomassarea ~ Richness +temp + prod.annual + log_grav_total*Class*Netflow  + log_Inflow+
                                  log_SelfR + log_btwdegree +log_grav_neiBR + log_InflowNei +log_CorridorIn + 
                                  (1+   temp + prod.annual + log_grav_total*Class*Netflow  + log_Inflow+
                                     log_SelfR + log_btwdegree +log_grav_neiBR + log_InflowNei +log_CorridorIn |region))
...
saveRDS(all_fit_brms.tot.TRANSIENT.intr.extr,"ACTIVE_models/Inflow/all_fit_brms.tot.TRANSIENT.intr.extr_INFLOW.Rds")
...
all_fit_brms.nocon.S.TRANSIENT.intr.extr <-brm(species_mod_inflow.intr.extr.simp + biom_mod_nocon.S + set_rescor(FALSE), data=TRANSIENT.std,cores=10,chains = 4,
                                          iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                          prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.S.TRANSIENT.intr.extr,"ACTIVE_models/Inflow/all_fit_brms.nocon.S.TRANSIENT.intr.extr_INFLOW.Rds")
...
all_fit_brms.nocon.TRANSIENT <-brm(S_mod_nocon + biom_mod_nocon.S + set_rescor(FALSE), data=TRANSIENT.std,cores=10,chains = 4,
                                  iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                  prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.TRANSIENT,"ACTIVE_models/Inflow/all_fit_brms.nocon.TRANSIENT_INFLOW.Rds")
...
all_fit_brms.nocon.S.RESID.intr.extr <-brm(species_mod_inflow.intr.extr.simp + biom_mod_nocon.S + set_rescor(FALSE), data=RESID.std,cores=10,chains = 4,
                                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                               prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.S.RESID.intr.extr,"ACTIVE_models/Inflow/all_fit_brms.nocon.S.RESID.intr.extr_INFLOW.Rds")
...
all_fit_brms.nocon.RESID <-brm(S_mod_nocon + biom_mod_nocon.S + set_rescor(FALSE), data=RESID.std,cores=10,chains = 4,
                                   iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                   prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.RESID,"ACTIVE_models/Inflow/all_fit_brms.nocon.RESID_INFLOW.Rds")
...
all_fit_brms.nocon.S.PARENTAL.intr.extr <-brm(species_mod_inflow.intr.extr.simp + biom_mod_nocon.S + set_rescor(FALSE), data=PARENTAL.std,cores=10,chains = 4,
                                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                               prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.S.PARENTAL.intr.extr,"ACTIVE_models/Inflow/all_fit_brms.nocon.S.PARENTAL.intr.extr_INFLOW.Rds")
...
all_fit_brms.nocon.PARENTAL <-brm(S_mod_nocon + biom_mod_nocon.S + set_rescor(FALSE), data=PARENTAL.std,cores=10,chains = 4,
                                   iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                   prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.PARENTAL,"ACTIVE_models/Inflow/all_fit_brms.nocon.PARENTAL_INFLOW.Rds")
...
all_fit_brms.nocon.S.CRYPTIC.intr.extr <-brm(species_mod_inflow.intr.extr.simp + biom_mod_nocon.S + set_rescor(FALSE), data=CRYPTIC.std,cores=10,chains = 4,
                                               iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                               prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.S.CRYPTIC.intr.extr,"ACTIVE_models/Inflow/all_fit_brms.nocon.S.CRYPTIC.intr.extr_INFLOW.Rds")
...
all_fit_brms.nocon.CRYPTIC <-brm(S_mod_nocon + biom_mod_nocon.S + set_rescor(FALSE), data=CRYPTIC.std,cores=10,chains = 4,
                                   iter = 5000, warmup = 1000,thin = 2, refresh = 0, control = list(adapt_delta = 0.99999,max_treedepth = 30),
                                   prior = c(prior(normal(0, 100),class = "Intercept"), prior(normal(0, 100), class = "b")))
saveRDS(all_fit_brms.nocon.CRYPTIC,"ACTIVE_models/Inflow/all_fit_brms.nocon.CRYPTIC_INFLOW.Rds")
